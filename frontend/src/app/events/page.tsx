              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6 w-full">
                {paginatedEvents.map((event) => {
                  ...
                  return (
                    <Card
                      key={event.id}
                      className={`hover:shadow-lg transition-shadow w-full max-w-full ${isPast ? 'opacity-60' : ''}`}
                    >
                      <CardContent className="p-4 w-full">
                        <div className="flex flex-col gap-4 w-full max-w-full">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2 mb-2">
                              <h3 className="text-lg sm:text-xl font-bold text-gray-900 line-clamp-2 break-words">
                                {event.name}
                              </h3>
                              {isPast && (
                                <span className="px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-700 whitespace-nowrap flex-shrink-0">
                                  Past
                                </span>
                              )}
                            </div>
                            <p className="text-xs text-gray-500 font-mono mb-3 break-all">{event.event_code}</p>
                            ...
                            <div className="space-y-2 mb-4">
                              ...
                              <div className="flex items-start gap-2 text-gray-600">
                                ...
                                <span className="text-sm line-clamp-2 break-words">{event.address}</span>
                              </div>
                            </div>
